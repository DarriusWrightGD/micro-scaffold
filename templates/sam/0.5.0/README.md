...
This is a sample template for cli-sample - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name cli-sample --query 'Stacks[].Outputs'
```
